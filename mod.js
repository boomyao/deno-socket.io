...
import { readFileStrSync as read } from 'https://deno.land/std/fs/mod.ts'
import * as path from 'https://deno.land/std/path/mod.ts'
import { existsSync as exists } from 'https://deno.land/std/fs/mod.ts'
import * as engine from './engine.io/engine.io.js'
var clientVersion = '0.0.1'
import * as Client from './client.js'
import { EventEmitter as Emitter } from 'https://deno.land/std/node/events.ts'

import Namespace from './namespace.js'
import ParentNamespace from './parent-namespace.js'
import * as Adapter from './socket.io-adapter/mod.js'
import * as parser from './socket.io-parser/mod.js'
...
Server.prototype.serveClient = function(v){
  ...
  if (v && !clientSource) {
    clientSource = read(resolvePath( 'socket.io-client/dist/socket.io.js'));
    try {
      clientSourceMap = read(resolvePath( 'socket.io-client/dist/socket.io.js.map'));
    } catch(err) {
